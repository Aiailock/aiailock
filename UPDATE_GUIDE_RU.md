...
> Эта инструкция относится к патчу 0012. Для актуального обновления 0013
> (мобильная Студия, главы, альбомы, GIF, даты, фоны и реакции) используй
> `PATCH_0013_STORY_STUDIO_RU.md`; сначала выполни шаги 0012, если они ещё не
> применялись, затем шаги 0013.
